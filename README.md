...
## At a Glance
* 11 CPU architectures supported (x86, amd64, riscv64, arm64, ia64, sparc64, arm, sparc, ppc64, mips64, loongarch64)
* Strict layered OS design
* UEFI-first modern boot path
* Kernel-level networking stack
* Desktop environment already running
* Universal app format (`.gxapp`)
---

## What is guideXOS Server?

guideXOS Server is a computer operating system focused on one big idea:
**What if apps could run across completely different CPU architectures... natively?**
Instead of locking software to x86 or ARM, guideXOS Server supports a universal application platform backed by a multi-architecture kernel.
---
...
* Reviewed public target allowlist v0.5:
  ...
  * `https://example.com/` as the first real HTML/Navigator public-page target
  * `https://www.gnu.org/`, `https://news.ycombinator.com/`, and `https://en.wikipedia.org/` as the next reviewed HTML targets
