...
#if defined(_WIN32) && defined(__x86_64__)
// Opt-in, fail-through diagnostics for hosted native-image faults. The handler
// records the fault and returns EXCEPTION_CONTINUE_SEARCH; it never changes
// the security-cookie, fast-fail, or structured-exception contract.
