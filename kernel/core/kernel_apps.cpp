...
void NavigatorApp::buildRuntimeDocument()
{
    ...
    strcopy(prerequisiteLine, "Secure RNG: source=", sizeof(prerequisiteLine));
    strappend(prerequisiteLine, gxos::gxos_secure_random_source(), sizeof(prerequisiteLine));
    strappend(prerequisiteLine, "; status=", sizeof(prerequisiteLine));
    strappend(prerequisiteLine, gxos::gxos_secure_random_status(), sizeof(prerequisiteLine));
    addBlock(BLOCK_LIST_ITEM, prerequisiteLine);
    strcopy(prerequisiteLine, "CPU RNG: RDSEED=", sizeof(prerequisiteLine));
    strappend(prerequisiteLine, gxos::gxos_rdseed_supported() ? "supported" : "unsupported", sizeof(prerequisiteLine));
    strappend(prerequisiteLine, "; RDRAND=", sizeof(prerequisiteLine));
    strappend(prerequisiteLine, gxos::gxos_rdrand_supported() ? "supported" : "unsupported", sizeof(prerequisiteLine));
    addBlock(BLOCK_LIST_ITEM, prerequisiteLine);
...
static bool printNavigatorRuntimeSmokePreamble()
{
    ...
    serial::puts("\n[NAVIGATOR-SMOKE] tls_prereq.secure_rng_source=");
    serial::puts(gxos::gxos_secure_random_source());
    serial::puts("\n[NAVIGATOR-SMOKE] tls_prereq.secure_rng_status=");
    serial::puts(gxos::gxos_secure_random_status());
    serial::puts("\n[NAVIGATOR-SMOKE] tls_prereq.rdseed_supported=");
    serial::puts(gxos::gxos_rdseed_supported() ? "yes" : "no");
    serial::puts("\n[NAVIGATOR-SMOKE] tls_prereq.rdrand_supported=");
    serial::puts(gxos::gxos_rdrand_supported() ? "yes" : "no");
