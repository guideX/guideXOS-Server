    ...
    while (index < sourceLength) {
        ...
        if (c == '"') {
            ...
            while (index < sourceLength) {
                ...
                if (value == '\\') {
                    advance(source, sourceLength, &index, &line, &column);
                    if (index < sourceLength) advance(source, sourceLength, &index, &line, &column);
                } else {
                    advance(source, sourceLength, &index, &line, &column);
                }
            }
            ...
            if (!add_token(tokens, tokenCapacity, tokenCount, TokenKind::String,
                           stringLocation, index - stringLocation.offset, diagnostics)) return false;
            continue;
        }
