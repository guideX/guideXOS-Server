...
static void help(){
    std::cout << "Commands:\n"
                 ...
                 " desktop.wallpaper <path> | desktop.launch <action> | desktop.launch.resolve <label> | desktop.launch.compare | desktop.pin <action> | desktop.unpin <action> | desktop.showconfig\n"
