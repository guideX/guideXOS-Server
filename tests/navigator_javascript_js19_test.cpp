...
grandparent.addEventListener("click", function(event) {
    ...
    expect(harness.runtime().propertyCount() == propertiesBefore + 11u,
        "metadata: cached Event adds exactly eleven fixed properties");
...
parent.addEventListener("click", function(event) {
    ...
    expect(stress.runtime().propertyCount() == stressProperties + 11u,
