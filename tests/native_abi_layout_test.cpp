...
static_assert(offsetof(gx_host_calls, bare_metal_build_project_start) == 288, "bare-metal build start slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_build_project_poll) == 296, "bare-metal build poll slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_build_project_release) == 304, "bare-metal build release slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_file_stat) == 312, "bare-metal file stat slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_file_read_workspace) == 320, "bare-metal file read slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_file_list) == 328, "bare-metal file list slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_file_write_all) == 336, "bare-metal file write slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_file_create_directory) == 344, "bare-metal mkdir slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_file_remove) == 352, "bare-metal remove slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_development_run_prepare) == 360, "bare-metal run prepare slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_development_run_start) == 368, "bare-metal run start slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_development_run_poll) == 376, "bare-metal run poll slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_development_run_request_close) == 384, "bare-metal run close slot changed");
static_assert(offsetof(gx_host_calls, bare_metal_development_run_release) == 392, "bare-metal run release slot changed");
static_assert(sizeof(gx_host_calls) == 400, "gx_host_calls size changed");
static_assert(offsetof(gx_development_run_request, artifactSize) == 72, "run artifact size field changed");
static_assert(offsetof(gx_development_run_request, artifactArchitecture) == 80, "run artifact architecture field changed");
static_assert(offsetof(gx_development_run_request, artifactAbi) == 88, "run artifact ABI field changed");
static_assert(offsetof(gx_development_run_request, capabilities) == 96, "run capability field changed");
static_assert(offsetof(gx_development_run_request, reservedV2) == 100, "run v2 reserved field changed");
static_assert(sizeof(gx_development_run_request) == 104, "gx_development_run_request size changed");
static_assert(offsetof(gx_development_run_snapshot, reservedOutputAlignment) == 444, "run output alignment changed");
static_assert(offsetof(gx_development_run_snapshot, outputCount) == 448, "run output count changed");
static_assert(offsetof(gx_development_run_snapshot, outputTruncated) == 452, "run output truncation changed");
static_assert(offsetof(gx_development_run_snapshot, output) == 456, "run output lines changed");
static_assert(offsetof(gx_development_run_snapshot, capabilities) == 4552, "run snapshot capability field changed");
static_assert(offsetof(gx_development_run_snapshot, reservedV2) == 4556, "run snapshot v2 reserved field changed");
static_assert(sizeof(gx_development_run_snapshot) == 4560, "gx_development_run_snapshot size changed");
