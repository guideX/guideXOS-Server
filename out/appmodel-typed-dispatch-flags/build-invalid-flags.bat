...
set CXXFLAGS=-std=c++17 -Wall -O2 -iquote . -DGXOS_APPMODEL_TYPED_DISPATCH_SHADOW_ONLY -DGXOS_APPMODEL_TYPED_DISPATCH_ENABLED
...
REM Output
set OUTPUT=out\appmodel-typed-dispatch-flags\guideXOSServer.invalid-flags.exe
