...
extern "C" __declspec(noreturn) void __cdecl guideXosNativeAotCollectionBoundarySafeStop(uint32_t reason);
...
void GCToEEInterface::SuspendEE(SUSPEND_REASON reason)
{
    ...
    guideXosNativeAotCollectionBoundarySafeStop((uint32_t)reason);
#endif
