...
extern "C" uint32_t g_guidexos_nativeaot_gc_startup_diagnostic_stage;
extern "C" uint32_t g_guidexos_nativeaot_gc_startup_stage;
...
{
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x50u;
#ifdef FEATURE_CACHED_INTERFACE_DISPATCH
    //
    // Initialize interface dispatch.
    //
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x51u;
    if (!InitializeInterfaceDispatch()) {
        g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x5Fu;
        return false;
    }
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x52u;
#endif

    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x53u;
    ...
    //
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x54u;
    if (!RestrictedCallouts::Initialize()) {
        g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x5Eu;
        return false;
    }
    ...
    //
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x55u;
    if (!RuntimeInstance::Initialize(hPalInstance)) {
        g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x5Du;
        return false;
    }
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x56u;
    ...
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x60u;
    if (!InitializeGC()) {
        if (g_guidexos_nativeaot_gc_startup_diagnostic_stage == 0x60u) {
            g_guidexos_nativeaot_gc_startup_diagnostic_stage =
                0x6F000000u | (g_guidexos_nativeaot_gc_startup_stage & 0x00FFFFFFu);
        }
        return false;
    }
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x61u;
...
{
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x40u;
    if (!PalInit())
        return false;

    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x41u;
    ...
    g_guidexos_nativeaot_gc_startup_diagnostic_stage = 0x70u;
