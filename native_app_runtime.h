...
struct NativeHostCallTable {
    ...
    gx_result (*bare_metal_build_project_start)(NativeGxAppContext* ctx, const gx_build_request* request, gx_build_handle* outHandle) = nullptr;
    gx_result (*bare_metal_build_project_poll)(NativeGxAppContext* ctx, gx_build_handle handle, gx_build_snapshot* outSnapshot) = nullptr;
    gx_result (*bare_metal_build_project_release)(NativeGxAppContext* ctx, gx_build_handle handle) = nullptr;
    gx_result (*bare_metal_file_stat)(NativeGxAppContext* ctx, const char* path, gx_file_info* outInfo) = nullptr;
    gx_result (*bare_metal_file_read_workspace)(NativeGxAppContext* ctx, const char* path, void* buffer, uint32_t bufferSize, uint32_t* outBytesRead) = nullptr;
    gx_result (*bare_metal_file_list)(NativeGxAppContext* ctx, const char* path, gx_file_entry* entries, uint32_t capacity, uint32_t* outCount, uint32_t* outTruncated) = nullptr;
    ...
    gx_handle (*native_window_create)(NativeGxAppContext* ctx, int width, int height, const char* title) = nullptr;
    ...
    gx_result (*bare_metal_development_debug)(NativeGxAppContext* ctx,
                                               const gx_development_debug_request* request,
                                               gx_development_debug_snapshot* snapshot) = nullptr;
    gx_result (*development_debug_call_stack)(NativeGxAppContext* ctx,
                                               const gx_development_debug_request* request,
                                               gx_development_debug_call_stack* result) = nullptr;
    gx_result (*bare_metal_development_debug_call_stack)(NativeGxAppContext* ctx,
                                                          const gx_development_debug_request* request,
                                                          gx_development_debug_call_stack* result) = nullptr;
    gx_result (*development_debug_inspect_variables)(NativeGxAppContext* ctx,
                                                      const gx_development_debug_request* request,
                                                      gx_development_debug_variables* result) = nullptr;
    gx_result (*bare_metal_development_debug_inspect_variables)(NativeGxAppContext* ctx,
                                                                 const gx_development_debug_request* request,
                                                                 gx_development_debug_variables* result) = nullptr;
    gx_result (*development_debug_evaluate_expression)(NativeGxAppContext* ctx,
                                                        const gx_development_debug_request* request,
                                                        gx_development_debug_expression* result) = nullptr;
    gx_result (*bare_metal_development_debug_evaluate_expression)(NativeGxAppContext* ctx,
                                                                   const gx_development_debug_request* request,
                                                                   gx_development_debug_expression* result) = nullptr;
};
...
static_assert(offsetof(NativeHostCallTable, bare_metal_build_project_start) == 240, "native ABI bare-metal build start slot changed");
static_assert(offsetof(NativeHostCallTable, bare_metal_build_project_poll) == 248, "native ABI bare-metal build poll slot changed");
static_assert(offsetof(NativeHostCallTable, bare_metal_build_project_release) == 256, "native ABI bare-metal build release slot changed");
static_assert(offsetof(NativeHostCallTable, bare_metal_file_stat) == 264, "native ABI bare-metal file stat slot changed");
static_assert(offsetof(NativeHostCallTable, bare_metal_file_read_workspace) == 272, "native ABI bare-metal file read slot changed");
static_assert(offsetof(NativeHostCallTable, bare_metal_file_list) == 280, "native ABI bare-metal file list slot changed");
...
static_assert(offsetof(NativeHostCallTable, native_window_create) == 352, "native ABI native window create slot changed");
...
static_assert(offsetof(NativeHostCallTable, native_window_run) == 376, "native ABI native window run slot changed");
    ...
    static_assert(offsetof(NativeHostCallTable, bare_metal_development_debug) == 392,
              "native ABI bare-metal development debug slot changed");
    static_assert(offsetof(NativeHostCallTable, development_debug_call_stack) == 400,
              "native ABI hosted call stack slot changed");
    static_assert(offsetof(NativeHostCallTable, bare_metal_development_debug_call_stack) == 408,
              "native ABI bare-metal call stack slot changed");
    static_assert(offsetof(NativeHostCallTable, development_debug_inspect_variables) == 416,
              "native ABI hosted variable inspection slot changed");
    static_assert(offsetof(NativeHostCallTable, bare_metal_development_debug_inspect_variables) == 424,
              "native ABI bare-metal variable inspection slot changed");
    static_assert(offsetof(NativeHostCallTable, development_debug_evaluate_expression) == 432,
              "native ABI hosted expression slot changed");
    static_assert(offsetof(NativeHostCallTable, bare_metal_development_debug_evaluate_expression) == 440,
              "native ABI bare-metal expression slot changed");
    static_assert(sizeof(NativeHostCallTable) == 448, "native ABI host call table size changed");
