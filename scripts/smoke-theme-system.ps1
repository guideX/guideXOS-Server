...
$themeRecommendationTextMatch = Find-RawMatch $displayOptions 'Recommended backgrounds for Sci Fi: guideXOS Space, guideXOS Space 2, Tron Porsche, CPU\..*?Change this on the Background tab\.'
