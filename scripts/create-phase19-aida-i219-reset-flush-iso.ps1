...
$version = '0.1.0-phase19-aida-i219-reset-flush'

Write-Host "[phase19-iso] Building I219 reset-flush audit image ($version)" -ForegroundColor Cyan
...
if ($LASTEXITCODE -ne 0) {
    throw 'canonical build failed for Phase 19 I219 reset-flush image'
}
...
if ($LASTEXITCODE -ne 0) {
    throw 'release ISO packaging failed for Phase 19 I219 reset-flush image'
}

Write-Host "[phase19-iso] Created guideXOS-Server-v$version-amd64.iso with SHA-256 and manifest" `
