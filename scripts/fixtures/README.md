...
- Purpose: smoke-only root CA bundle fixture for bare-metal TLS prerequisite coverage.
...
- Provenance: checked-in deterministic PEM fixture matching the existing localhost smoke certificate chain material in this repository.
