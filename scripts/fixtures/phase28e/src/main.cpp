...
{
    log(ctx, "DEVELOPER_STUDIO_PHASE28E_PRE_BREAKPOINT_ONCE");
    int value = 27;
    value = value + 0;
    value = value + 0;
    value = value + 0;
    ...
    value = value + 1;
    value = value + 1;
    int window = gx_window_create(320, 180, "Developer Studio Phase 28E");
    if (window == 0) return -1;
    if (gx_window_set_text(window, "28E GUI 40") != 0) return -2;
