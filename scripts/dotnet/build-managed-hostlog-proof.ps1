...
try {
    ...
    if ($IncludeC136FocusedTests) {
        $publishProperties += "-p:HostLogProofC136IncludeFocusedTests=true"
    }
    $publishBatch = @(
        "@echo off"
        "setlocal"
