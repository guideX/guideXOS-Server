...
if (($Phase28L -or $Phase28M) -and $TimeoutSeconds -lt 120) { $TimeoutSeconds = 120 }
...
try {
    ...
    if ($Phase28LOnly -or $Phase28MOnly) {
        $proofLabel = if ($Phase28MOnly) { "Phase 28M" } else { "Phase 28L" }
