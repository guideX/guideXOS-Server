...
function Invoke-QemuProofBoot([int]$runNumber, [string]$qemu) {
    ...
    try {
        ...
        if ($Phase27VOnly -or $Phase27WOnly -or $Phase27XOnly -or $Phase27YOnly -or $Phase27ZOnly -or $Phase28AOnly -or $Phase28BOnly -or $Phase28COnly -or $Phase28DOnly -or $Phase28EOnly -or $Phase28FOnly -or $Phase28GOnly -or $Phase28HOnly -or $Phase28IOnly -or $Phase28JOnly -or $Phase28KOnly) { $requiredMarkers = @() }
        ...
        if ($missingMarkers.Count -ne 0) {
            ...
            if (-not $Phase27U -and -not $Phase28FOnly -and -not $Phase28HOnly -and -not $Phase28IOnly -and -not $Phase28JOnly -and -not $Phase28KOnly -and $serial) { Write-Host $serial }
        ...
        if ($Phase28JOnly -or $Phase28KOnly) {
...
try {
    ...
    $serialArtifacts = @("r42")
    foreach ($candidate in @("d27a", "d27b", "d27c", "f28main", "g28main", "h28main", "j28main", "k28main")) {
