...
if ($Phase27U -and $TimeoutSeconds -lt 120) { $TimeoutSeconds = 120 }
...
try {
    ...
    try {
        ...
        if ($Phase27E -or $Phase27F -or $Phase27M -or $Phase27O -or $Phase27P -or $Phase27Q -or $Phase27R -or $Phase27S -or $Phase27T -or $Phase27U) {
