...
$checks = @(
    ...
    "[NAVIGATOR-SMOKE] tls_prereq.tls_backend_status=SourceMissing",
    ...
    "[NAVIGATOR-SMOKE] tls_prereq.tls_arena_detail=(none)",
    ...
    "[NAVIGATOR-SMOKE] tls_prereq.hostname_validation_available=no",
    ...
    "[NAVIGATOR-SMOKE] tls_prereq.hostname_validation_policy=scaffolded only; original URL host is retained for future SNI and certificate checks, but Mbed TLS source import is still missing",
    "[NAVIGATOR-SMOKE] tls_prereq.certificate_validation_policy=disabled; original URL host is retained for future SNI and hostname checks, but Mbed TLS source import is missing",
    "[NAVIGATOR-SMOKE] tls_readiness=no",
    "[NAVIGATOR-SMOKE] tls_readiness_blocker=Vendored Mbed TLS source tree is missing at third_party/mbedtls; handshake support stays disabled.",
