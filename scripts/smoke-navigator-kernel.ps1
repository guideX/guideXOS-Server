...
$checks = @(
    ...
    "[NAVIGATOR-SMOKE] capability.http=enabled numeric IPv4 and hostname HTTP/1.0 GET with redirects/chunked",
    ...
    "[NAVIGATOR-SMOKE] capability.forms_post_bare_metal=unsupported in kernel adapter",
    "[NAVIGATOR-SMOKE] capability.forms_controls=text, checkbox, radio, textarea, select, submit",
    "[NAVIGATOR-SMOKE] capability.forms_focus_navigation=Tab/Shift+Tab, Enter, Space where form UI is available",
