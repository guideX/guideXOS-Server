...
$version = '0.1.0-phase8-aida-i219-init'

Write-Host "[phase8-iso] Building AIDA_LPT I219 driver-ready image ($version)" -ForegroundColor Cyan
...
if ($LASTEXITCODE -ne 0) { throw 'canonical build failed for Phase 8 I219 driver-ready image' }
...
if ($LASTEXITCODE -ne 0) { throw 'release ISO packaging failed for Phase 8 I219 driver-ready image' }

Write-Host "[phase8-iso] Created guideXOS-Server-v$version-amd64.iso with SHA-256 and manifest" -ForegroundColor Green
