...
Assert-True (-not $virtioGpuCpp.Contains('timer-driven frame presentation')) 'virtio_gpu.cpp should not introduce timer-driven presentation'
Assert-True (-not $virtioGpuCpp.Contains('scheduler')) 'virtio_gpu.cpp should not introduce scheduler-driven presentation'
Assert-True (-not $virtioGpuCpp.Contains('invalidation')) 'virtio_gpu.cpp should not introduce invalidation-driven presentation'
