...
$evidence = [ordered]@{
    ...
    evidence_lane = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "evidence_lane"
    tls_suite_contract = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_suite_contract"
    tls_suite_contract_count = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_suite_contract_count")
    tls_suite_contract_real_count = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_suite_contract_real_count")
    tls_suite_contract_installed = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_suite_contract_installed"
    tls_clienthello_real_suite_count = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_clienthello_real_suite_count")
    tls_clienthello_scsv_only = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_clienthello_scsv_only"
    tls_clienthello_contract_match = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_clienthello_contract_match"
    tls_negotiated_suite = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "tls_negotiated_suite"
    ...
    request_accept_encoding = Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "request_accept_encoding"
    body_bytes = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "body_bytes")
    encoded_body_bytes = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "encoded_body_bytes")
    decoded_body_bytes = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "decoded_body_bytes")
    decoded_body_cap = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "decoded_body_cap")
    decoded_cap_headroom = ConvertTo-NavigatorNullableInt (Get-NavigatorPublicHttpsFieldValue -Fields $fields -Name "decoded_cap_headroom")
