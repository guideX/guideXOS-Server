...
$version = '0.1.0-phase13-aida-i219-tx-completion'

Write-Host "[phase13-iso] Building I219 TX-completion image ($version)" -ForegroundColor Cyan
...
if ($LASTEXITCODE -ne 0) { throw 'canonical build failed for Phase 13 I219 TX-completion image' }
...
if ($LASTEXITCODE -ne 0) { throw 'release ISO packaging failed for Phase 13 I219 TX-completion image' }

Write-Host "[phase13-iso] Created guideXOS-Server-v$version-amd64.iso with SHA-256 and manifest" -ForegroundColor Green
