...
Assert-Match -Path $kernelMain -Pattern 'FramebufferUniqueCount' -Message 'Kernel does not read BootInfo unique framebuffer count.'
Assert-Match -Path $kernelMain -Pattern 'FramebufferDuplicateCount' -Message 'Kernel does not read BootInfo duplicate framebuffer count.'
Assert-Match -Path $kernelMain -Pattern 'FramebufferSuspiciousCount' -Message 'Kernel does not read BootInfo suspicious framebuffer count.'
